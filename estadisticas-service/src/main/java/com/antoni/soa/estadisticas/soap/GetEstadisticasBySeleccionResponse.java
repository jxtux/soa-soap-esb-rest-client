...
@XmlRootElement(name = "getEstadisticasBySeleccionResponse", namespace = "http://soa.antoni.com/estadisticas")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetEstadisticasBySeleccionResponse {
    @XmlElementWrapper(name = "estadisticas")
    @XmlElement(name = "estadistica")
    private List<Estadistica> estadisticas = new ArrayList<>();

    public GetEstadisticasBySeleccionResponse() {}
    public GetEstadisticasBySeleccionResponse(List<Estadistica> estadisticas) { this.estadisticas = estadisticas; }
