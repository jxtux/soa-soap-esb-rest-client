...
@XmlRootElement(name = "getAllSeleccionesResponse", namespace = "http://soa.antoni.com/selecciones")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetAllSeleccionesResponse {
    @XmlElementWrapper(name = "selecciones")
    @XmlElement(name = "seleccion")
    private List<Seleccion> selecciones = new ArrayList<>();

    public GetAllSeleccionesResponse() {}
    public GetAllSeleccionesResponse(List<Seleccion> selecciones) { this.selecciones = selecciones; }
